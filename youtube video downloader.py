...
#Label
my_canvas.create_text(250,20,text="Youtube Video Converter",font=("UnifrakturCook-Bold",15),fill="Green")  #.grid(sticky=N,padx=100,row=0)
my_canvas.create_text(250,60,text="Please enter your youtube video link below:",font=("Calibri",12),fill="white")  #.grid(sticky=N,row=1,pady=15)
my_canvas.create_text(250,140,text="Please enter name of the saved video:",font=("Calibri",12),fill="white") #.grid(sticky=N,row=3,pady=15)
my_canvas.create_text(250,220,text="Please path where you want to store your music (only once):",font=("Calibri",12),fill="white") #.grid(sticky=N,row=5,pady=15)
...
e2=Entry(textvariable=nazwapliku,width=50 ,bg='white',fg='black') #master,width=50
my_canvas.create_window(250,180,window=e2)

e3 = Entry(master,width=50,textvariable=sciezkaUserInput) #.grid(sticky=N,row=6)
my_canvas.create_window(250,260,window=e3)
#Button
b1 = Button(master,width=30,text="Download only audio",bg="#03fce8",font=("Calibri",12),command=downloadAudio) #.grid(sticky=N,row=7,pady=15)
my_canvas.create_window(250,300,window=b1)
b2 = Button(master,width=30,text="Download in low resolution",bg="green",font=("Calibri",12),command=downloadLow) #.grid(sticky=N,row=8,pady=15)
my_canvas.create_window(250,350,window=b2)
b3 = Button(master,width=30,text="Download in high resolution",bg="orange",font=("Calibri",12),command=downloadHigh) #.grid(sticky=N,row=9,pady=15)
